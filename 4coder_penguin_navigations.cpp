...
#ifndef FCODER_PENGUIN_NAVIGATION_
#define FCODER_PENGUIN_NAVIGATION_
...
void windmove_to_panel(Application_Links* app, u8 direction, b32 swap_on_move);
...
#endif // FCODER_PENGUIN_NAVIGATION_